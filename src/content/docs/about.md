---
title: About cloudless computer
description: Helping you to break free from Big Tech dependency
template: splash
hero:
  tagline: Helping you get your digital privacy back
---

# Your data. Your software. Your AI.
...
## About Dr. Daniel Bender

<img src="/profile-wave-1000x750.jpg" alt="Daniel Bender" style="width: 500px; margin: 2rem 0;">
...
While most tech companies profit from your attention and data, I believe you deserve tools that respect your privacy and put you in control.

I believe:

- **Your data is your property** – What you create, ask, and communicate should never be mined, analyzed, or sold.
- **Ownership beats convenience** – True security comes from running software on infrastructure you control, not rented servers you don't.
...
I believe the only reliable path to digital sovereignty is through observation, experimentation, and iteration. Unlike shortcuts or one-size-fits-all solutions, this process helps you:

- **Observe** the current landscape of cloudless tools and technologies.
- **Discover** your unique path through experimentation with local-first software.
...
Sometimes a small idea can change anything. Start to explore alternatives to the well established cloud services.

### Newsletter

Get practical tutorials, tool recommendations, and strategies designed to help you reduce your cloud dependency and run more software locally. The content is often quite technical, but I do my best to write it in a way that it also helps non-technical readers.

### Digital Garden

A growing collection of notes, tools, and ideas about privacy, local-first software, and digital ownership. Browse freely, follow connections, and discover new approaches to reclaiming your digital life.

<!--
### Resources & Guides

Curated configurations, recommended hardware, and step-by-step walkthroughs for setting up local AI assistants, self-hosted tools, and privacy-respecting workflows.
-->
...
Have a question, collaboration idea, or just want to share something from your cloudless journey? I would love to hear from you.
